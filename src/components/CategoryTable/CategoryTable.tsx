...
const CategoryTable: React.FC = () => {
    ...
    const deleteCategory = async (id: number) => {
        ...
        if (result.status === 204) {
            ...
            setTotal(total - 1);
            if ((total - 1) % searchData.perPage == 0 && searchData.page > 1)
    ...
    return (
        <>
            <button onClick={() => navigate('/create-edit/0')} type="button" className="z-50  shadow-xl fixed top-20 right-10 px-3 py-2 text-xl font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
